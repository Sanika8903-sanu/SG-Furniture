...
?>
                    ...
                    <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                        ...
                        <div class="form-group"><!-- form-group Begin -->
                            ...
                            <div class="col-md-6"><!-- col-md-6 Begin -->
                                ...
                                <input value="<?php echo $user_city; ?>" name="admin_city" type="text" class="form-control" required>
    ...
    if (isset($_POST['update'])) {
        ...
        $update_user = "update admins set admin_name='$user_name',admin_email='$user_email',admin_pass='$user_pass',admin_city='$user_city',admin_contact='$user_contact',admin_image='$user_image' where admin_id='$user_id'";
